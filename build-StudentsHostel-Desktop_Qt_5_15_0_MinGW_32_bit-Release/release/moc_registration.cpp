...
#include <memory>
#include "../../StudentsHostel/registration.h"
...
QT_MOC_LITERAL(3, 24, 13) // "on_Ok_clicked"

    },
    "Registration\0startAuth\0\0on_Ok_clicked"
};
...
void Registration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Registration::startAuth)) {
                *result = 0;
                return;
            }
        }

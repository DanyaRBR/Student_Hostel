...
#include <memory>
#include "../../StudentsHostel/authorization.h"
...
QT_MOC_LITERAL(1, 14, 9), // "succesful"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5), // "User*"
QT_MOC_LITERAL(4, 31, 16) // "on_LogIn_clicked"

    },
    "authorization\0succesful\0\0User*\0"
    "on_LogIn_clicked"
};
...
void authorization::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->succesful((*reinterpret_cast< User*(*)>(_a[1]))); break;
        ...
        {
            using _t = void (authorization::*)(User * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&authorization::succesful)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void authorization::succesful(User * _t1)
{

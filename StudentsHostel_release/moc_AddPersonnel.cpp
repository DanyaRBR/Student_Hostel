...
#include <memory>
#include "../../StudentsHostel/AddPersonnel.h"
...
QT_MOC_LITERAL(1, 13, 11), // "isStudExist"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "password"
QT_MOC_LITERAL(4, 35, 11), // "isPersExist"
QT_MOC_LITERAL(5, 47, 6) // "accept"

    },
    "AddPersonnel\0isStudExist\0\0password\0"
    "isPersExist\0accept"
};
...
void AddPersonnel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->isStudExist((*reinterpret_cast< const int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 1: { bool _r = _t->isPersExist((*reinterpret_cast< const int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
